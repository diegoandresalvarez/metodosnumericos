...
yi = interp1(x,y,xi,'spline','extrap');  h3a = plot(xi,yi,'k-','LineWidth',2);
...
p = polyfit(x,y,n-1);
h6 = plot(xi,polyval(p,xi),'m-','LineWidth',2);
axis([-10  10  -5  5]);

legend([h1 h2 h3a h3b h4 h5 h6], ...
    'nearest','linear','spline','funcion spline','pchip','cubic', 'lagrange', ...
